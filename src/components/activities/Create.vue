            ...
            <div class="col-12">
                <div class="card my-4">
                    ...
                    <div class="card-body pb-2">
                        <div class="row mb-3">
                            ...
                            <div class="col-12 col-md-8">
                                <input
                                    ...
                                    :class="{
                                        'is-invalid':
                                            props.validationErrorStatus.name,
                                    }"
                                    id="nameInput"
                                    type="text"
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-4">
                                <label class="form-label" for="startDateInput"
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-4">
                                <label class="form-label" for="startHourInput"
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-4">
                                <label class="form-label" for="maxStudentsInput"
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-4">
                                <label class="form-label" for="lacationInput"
                                    >Ubicación</label
                                >
                            </div>
                            <div class="col-12 col-md-8">
